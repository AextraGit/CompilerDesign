...
set CLASSPATH=
set MODULE_PATH=%APP_HOME%\lib\compiler-1.0-SNAPSHOT.jar;%APP_HOME%\lib\jspecify-1.0.0.jar

@rem Execute compiler
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COMPILER_OPTS%  -classpath "%CLASSPATH%" --module-path "%MODULE_PATH%" --module edu.kit.kastel.vads.compiler/edu.kit.kastel.vads.compiler.Main %*
